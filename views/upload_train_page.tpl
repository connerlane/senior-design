  ...
  <div class= "section white">
    ...
    <header class="header">
      <div class="container">
        <div class="row" style="text-align: center;border-radius: 12px">
          <div class="col s12">
            <h4 class="black-text lighten-1">Upload Juji Train Data</h3>
              <body style="color: red; font-size: 20px">WARNING: this action will overwrite the state of the predictive model. You may want to <a href="/download/weight_matrix/model.npz">download the current model</a> as a backup before performing this action. Also, this may take a few minutes to train.</a></body>
          </div>
        </div>
      </div>
    </header>
    <body class = "container">   
      <div class = "row" style="text-align: center; margin-top: 3%">
         <form class = "col s4 offset-s4" action="/upload_train_data" method="post" enctype="multipart/form-data">
            <div class = "row">
